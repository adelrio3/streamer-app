...
const toc = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..', 'addon', 'Compendium', 'Compendium.toc');
...
console.log(added.length ? `Added ${added.join(', ')}. Copy addon/Compendium into your AddOns folder again.` : 'Already listed.');
