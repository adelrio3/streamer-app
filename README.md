...
- **The web app** (`web/`, hosted on Netlify, data in Supabase) is open in Chrome on each computer and bridges them:
  ...
  - **World**, where every list is what you have done against everything in Classic, drilled down: Locations (continents → zones, with the quests done and the areas discovered in each), Bestiary (continents → zones → every creature there, "not yet", "seen" or "killed"; plus an encyclopedia by kind of what you have met, critters included), People (continents → zones → everyone who gives quests, sells, trains, flies or talks, "not yet", "seen" or "met"), Items (kinds → types → every item in the game, obtained or not, with percentages; quest items last), Zones (what happened where you have been, with a loose-ends checklist), Gathering (herbs, ore, chests and anything else you open)
